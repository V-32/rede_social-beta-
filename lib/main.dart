...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // A aplicação começa pela tela de Login
      home: const LoginPage(),
    );
  }
}

// Re-anexando a LoginPage aqui para garantir que o 'main' a encontre
...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Column(
        children: [
          // Barra de navegação superior (Gradiente)
          Container(
            height: 60,
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Botão que chama a Splash Screen
                        SizedBox(
                          width: double.infinity,
                          height: 50,
