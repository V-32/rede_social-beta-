            ...
            children: [
              ...
              Align(
                ...
                child: ElevatedButton(
                  onPressed: () { ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Alterações salvas!"))); }, 
  ...
  Widget _buildEditField(String label, TextEditingController controller) {
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        TextField(controller: controller, decoration: const InputDecoration(enabledBorder: UnderlineInputBorder(borderSide: BorderSide(color: Color(0xFFDFE1E6))), focusedBorder: UnderlineInputBorder(borderSide: BorderSide(color: Color(0xFF0052CC)))), style: const TextStyle(fontSize: 16)),
      ]),
    );
  }
}